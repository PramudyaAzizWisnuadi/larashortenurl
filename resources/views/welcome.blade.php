...
<html lang="en">
    ...
    <!-- Mirrored from pixner.net/cortaly/main/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 08 Oct 2024 08:20:53 GMT -->
    ...
    <body>
                ...
                <div class="header-wrapper">
                    ...
                    <ul class="menu">
                        ...
                        <li class="d-sm-none text-center">
                            <a href="sign-in.html" class="header-button active">Login</a>
                        </li>
                        <li class="d-sm-none text-center">
                            <a href="sign-up.html" class="mb-4 header-button">Register</a>
                        </li>
                    </ul>
                    ...
                    <div class="header-right">
                        <a href="sign-in.html" class="header-button d-none d-sm-inline-block m-0 active">Login</a>
                        <a href="sign-up.html" class="header-button d-none d-sm-inline-block m-0">Register</a>
                    </div>
                </div>
            </div>
        </header>
        ...
        <section class="banner-section">
            <div class="banner-bg bg_img" data-background="{{ asset('') }}assets/images/banner/banner-bg.jpg">
                <div class="banner-bg-shape"><img src="{{ asset('') }}assets/images/banner/banner-shape.png"
                        alt="banner"></div>
                <div class="round-1">
                ...
                <div class="row">
                    <div class="col-lg-6 mt-lg-100">
                        <div class="section-header left-style mb-lg-0 sticky-header mb-low ml-0">
                            ...
                            <p>Cortaly is a completely free tool where you can create short links, which apart from
                                being free, you get paid! So, now you can make money from home, when managing and
                                protecting your links.</p>
                    ...
                    <div class="col-lg-6">
                        <div class="choose-item">
                            <div class="choose-thumb">
                                <img src="{{ asset('') }}assets/images/why/01.png" alt="why">
                            </div>
                        ...
                        <div class="choose-item">
                            <div class="choose-thumb">
                                <img src="{{ asset('') }}assets/images/why/02.png" alt="why">
                            </div>
                            <div class="choose-content">
                                <h5 class="title">HIGHEST RATES</h5>
                                <p>Make the most out of your traffic with our always increasing rates. You are required
                                    to earn only $5.00 before you will be paid.</p>
                            </div>
                        </div>
                        <div class="choose-item">
                            <div class="choose-thumb">
                                <img src="{{ asset('') }}assets/images/why/03.png" alt="why">
                            </div>
                            <div class="choose-content">
                                <h5 class="title">PAYMENTS ON TIME</h5>
                                <p>We provide full mobile supports, you can even shorten the URL, control your account
                                    and view the stats on a mobile device.</p>
                            </div>
                        </div>
                        <div class="choose-item">
                            <div class="choose-thumb">
                                <img src="{{ asset('') }}assets/images/why/04.png" alt="why">
                            </div>
                            <div class="choose-content">
                                <h5 class="title">RESPONSIVE UI</h5>
                                <p>Request payments whenever you want and get your payments on 1st day and 15th day of
                                    every month. Enjoy you Spendings!!</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section class="feature-section padding-top oh padding-bottom pb-lg-half bg_img pos-rel"
            ...
            <div class="container">
                <div class="section-header cl-white">
                    ...
                    <p>
                        Mosto has plans, from free to paid, that scale with your needs. Subscribe to a plan that fits
                            ...
                            <div class="testimonial-area testimonial-slider owl-carousel owl-theme">
                                <div class="testimonial-item">
                                    <div class="testimonial-thumb">
                                        <div class="thumb">
                                            <img src="{{ asset('') }}assets/images/client/client1.jpg"
                                                alt="client">
                                        </div>
                                    </div>
                                    <div class="testimonial-content">
                                        ...
                                        <p>
                                            Lorem ipsum dolor sit amet, consectetur scing elit. Aliquam in nulla
                                            rhoncus, dapibus orci nec, venenatis eros.
                                        </p>
        ...
        <footer class="footer-section padding-top">
            <div class="footer-bg bg_img" data-background="{{ asset('') }}assets/images/footer/footer-bg.jpg">
            </div>
            <div class="footer-bg d-md-block d-none"><img src="{{ asset('') }}assets/images/footer/wave.png"
                    alt="footer"></div>
            <div class="container">
                ...
                <div class="footer-top">
                    ...
                    <ul class="links">
                        <li>
                            <a href="#0"><img src="{{ asset('') }}assets/images/footer/neteller.png"
                                    alt="footer"></a>
                        </li>
                        <li>
                            <a href="#0"><img src="{{ asset('') }}assets/images/footer/skrill.png"
                                    alt="footer"></a>
                        </li>
                        <li>
                            <a href="#0"><img src="{{ asset('') }}assets/images/footer/paypal.png"
                                    alt="footer"></a>
                        </li>
                    </ul>
                </div>
    ...
    <!-- Mirrored from pixner.net/cortaly/main/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 08 Oct 2024 08:21:45 GMT -->
